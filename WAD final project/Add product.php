...
input[type=text]
{
	...
	<form name="add products" action="Add.php" method="post"><table width="401" height="572" border="0" align="center" bgcolor="#49281A">
	  <tbody>
	    <tr>
	      <td colspan="2" style="text-align: center; font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif; font-size: 36px; color: #FFFFFF;">Add Product</td>
        </tr>
	    <tr>
	    ...
	    <tr>
	      <td width="109" height="40" style="color: #FFFFFF">Category</td>
	      <td width="144"><select name="selectcat" required id="selectcat">
			  <option value="">---------</option>
	    ...
	    <tr>
	      ...
	      <td><input name="txtname" type="text" id="txtname" size="19px"></td>
        </tr>
	    <tr>
	    ...
	    <tr>
	      ...
	      <td><input name="txtprice" type="text" id="txtprice" size="19px"></td>
        </tr>
	    <tr style="text-align: center">
	      <td colspan="2"><input type="submit" name="btnsubmit" id="btnsubmit" value="Add product">
