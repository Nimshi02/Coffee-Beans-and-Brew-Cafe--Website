...
<table align="center">
	...
	$sql="SELECT `number`,`name`,`price` FROM `beverages` WHERE `number`='".$bid."';";
...
&nbsp;
	...
	&nbsp;
	&nbsp;
<table width="415" border="0" align="center" bgcolor="#BD7F0B"><form name="product" method="post" action="Save to cart.php">
      <tbody>
        <tr>
        ...
        <tr>
          ...
          <td style="font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif"><input type="text" name="txttotal" id="txttotal" readonly></td>
	    </tr>
          ...
          <p style="text-align: center">
            ...
            <input type="button" name="btntot" id="btntot" value="Calculate total" onClick="calprice()">
          </p></td>
        </tr>
      </tbody></form>
</table>
