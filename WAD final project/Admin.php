...
&nbsp;
	...
	&nbsp;
<div class="box">&nbsp;&nbsp;
	<a href="Add product.php"><div class="small_box">
		<img src="Images/Images for admin page/tumblr_oea2zjMcoo1qak30bo1_500.gif" width="181" height="175">
		<br>
		<span style="font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif; font-size: 18px;"><strong>Add coffee </strong></span></div></a>
	
  <a href="Update beverage page.php"><div class="small_box2">
	<img src="Images/Images for admin page/0ba47d70c9e5da3c57b9c96a652020b0.gif" width="181" height="175">
		<br>
  <span style="font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif; font-size: 18px;"><strong>Update Beverages</strong></span></div></a>
	
	  <a href="update food item page.php"><div class="small_box5">
	<img src="Images/Images for admin page/cake.gif" width="181" height="175">
		<br>
  <span style="font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif; font-size: 18px;"><strong>Update Food Items </strong></span></div></a>
	
  <a href="delete beverages page.php"><div class="small_box6">
	<img src="Images/Images for admin page/mLW.gif" width="181" height="175">
		<br>
  <span style="font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif; font-size: 18px;"><strong>Delete Coffee</strong></span> </div> </a>
	
	<a href="delete food items page.php"><div class="small_box3">
	<img src="Images/Images for admin page/3Ln.gif" width="181" height="175">
		<br>
  <span style="font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif; font-size: 18px;"><strong>Delete Food Item</strong></span> </div> </a>
	
  <a href="Admins answers.php"><div class="small_box4">
	<img src="Images/Images for admin page/questions-cute.gif" width="181" height="175">
		<br>
  <span style="font-family: Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, sans-serif; font-size: 17px;"><strong>Answer the questions</strong></span></div></a>
</div>
	</div>
