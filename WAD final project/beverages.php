...
<link rel="stylesheet" type="text/css" href="beverage style.css">
</head>
	...
	<?php
		...
		if(mysqli_num_rows($result)>0)
		{
			...
			if($condition%2==1)
			{
				...
				echo"
			<tr>
			  <td width='462'><a href='buy beverage page.php?id=".$condition." '><div class='items'>
			    <p style='text-align: left'>".$row["name"]."<br>
				".$row["description"]."</p>
			    <p style='text-align: right'>Rs.".$row["price"]."</p>
				  </div></a></td>";
